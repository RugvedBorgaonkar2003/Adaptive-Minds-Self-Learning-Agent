...
- "is_complete": boolean (true ONLY if topic, level, and the sources question have been definitively answered)
...
if __name__ == "__main__":
    ...
    # Start the conversation with an initial trigger
    initial_trigger = "Hello, I am ready to learn."
    state["messages"].append(HumanMessage(content=initial_trigger))
